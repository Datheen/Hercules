...
export function Projects() {
  return (
    <div className="w-full bg-[#0b1b25] h-auto">
      <div id="container-projects" className="max-w-360 flex flex-col px-4 mx-auto">
        ...
        {/* Cards */}
        <div id="card-sction" className="grid mt-20 md:flex mx-auto gap-7 lg:gap-10 md:w-[90%]">
          {data.map((item) => (
            <div
              id="card"
              key={item.id}
              className="group shadow-2xl overflow-hidden bg-[url('@/assets/img/projects/project-1.webp')] border-1 border-white/80 active:scale-80 transition-all duration-700 bg-cover bg-center h-[370px] w-[380px] rounded-4xl"
            >
              ...
              <div className="bg-zinc-900/65 backdrop-blur-xl border border-white/10 h-[172px] rounded-b-4xl px-6">
