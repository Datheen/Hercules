      ...
      <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
            <div>
              ...
              <ul className="text-white font-medium">
                <li className="mb-4">
                  <a href="https://bun.com/" className="hover:underline">
                    Bun Software
                  </a>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a onClick={()=>(window.location.href="https://wa.me/5592985355192")} className="hover:cursor-pointer text-body hover:text-heading ms-5">
              <svg
                className="w-6 h-6 text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.x.com" className="text-body hover:text-heading ms-5">
              <svg
                className="w-6 h-6 text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.github.com" className="text-body hover:text-heading ms-5">
              <svg
                className="w-6 h-6 text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
